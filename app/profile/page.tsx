    ...
    <AppShell>
      <div className="mx-auto max-w-2xl space-y-3.5 lg:space-y-5">
        ...
        <section className="card-tint tint-blue corner-cut flex items-center gap-4 p-4 lg:p-5">
          <span className="grid size-14 shrink-0 place-items-center rounded-3xl border border-border/60 bg-white font-display text-xl font-bold text-foreground shadow-sm">
